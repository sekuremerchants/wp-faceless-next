"use strict";
(self["webpackChunksekure_website"] = self["webpackChunksekure_website"] || []).push([["chunks/blogs_global_ui"],{
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('scroll', function () {
        ...
        if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() >= minScroll) {
          if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').hasClass('header-toggled-state')) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header-logo').prop('src', logoLink + 'white-descriptor.webp');
            setTimeout(function () {
          ...
          if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').hasClass('header-toggled-state')) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header-logo').prop('src', logoLink + 'white-descriptor-tagline.webp');
            setTimeout(function () {
              jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').trigger('headerChanged');
            }, 355);
          }
...
//# sourceMappingURL=blogs_global_ui.js.map