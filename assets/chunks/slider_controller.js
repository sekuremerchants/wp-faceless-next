"use strict";
(self["webpackChunksekure_website"] = self["webpackChunksekure_website"] || []).push([["chunks/slider_controller"],{

/***/ "./assets/js/src/theme/ui/sliderController.js":
/*!****************************************************!*\
  !*** ./assets/js/src/theme/ui/sliderController.js ***!
  \****************************************************/
...
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/utils */ "./assets/js/src/theme/utils/utils.js");
  ...
  sliderElements.forEach(function (sliderElement) {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(sliderElement).hasClass('custom-pagination')) {
      var pagination = setInterval(function () {
        if (jquery__WEBPACK_IMPORTED_MODULE_2___default()('.blaze-pagination button').length) {
          var slides = jquery__WEBPACK_IMPORTED_MODULE_2___default()(sliderElement).find('.slide');
          slides.each(function (index) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_2___default()('.blaze-pagination').find('button').each(function (i) {
      ...
      var paginationScrollTo = setInterval(function () {
        if (jquery__WEBPACK_IMPORTED_MODULE_2___default()('.blaze-pagination button').length && window.innerWidth < 1025) {
          clearInterval(paginationScrollTo);
          jquery__WEBPACK_IMPORTED_MODULE_2___default()('.blaze-pagination button').on('click', function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(".blaze-next[data-btn-for=\"".concat(sliderID, "\"]")).on('click', function (e) {
      e.preventDefault();
      slider.next();
    });
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(".blaze-prev[data-btn-for=\"".concat(sliderID, "\"]")).on('click', function (e) {
      e.preventDefault();
      slider.prev();
    });
