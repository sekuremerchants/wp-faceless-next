"use strict";
(self["webpackChunksekure_website"] = self["webpackChunksekure_website"] || []).push([["chunks/carousel_controller"],{

/***/ "./assets/js/src/theme/plugins/lightslider/src/js/lightslider.js":
/*!***********************************************************************!*\
  !*** ./assets/js/src/theme/plugins/lightslider/src/js/lightslider.js ***!
  \***********************************************************************/
...
/***/ "./assets/js/src/theme/ui/carouselController.js":
/*!******************************************************!*\
  !*** ./assets/js/src/theme/ui/carouselController.js ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _plugins_lightslider_src_js_lightslider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../plugins/lightslider/src/js/lightslider */ "./assets/js/src/theme/plugins/lightslider/src/js/lightslider.js");
...
var carouselController = function carouselController() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.quote-carousel').each(function (_, slider) {
      if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(slider).hasClass('w-flxsd')) {
        var itemID = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.getUUID)();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(slider).attr('id', itemID);
        var slideCount = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + itemID + ' .slide').length;
        // console.log(slideCount);

        var TheSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + itemID + ' .slides').lightSlider({
          item: 1,
          autoWidth: false,
          slideMove: 1,
        ...
        if (slideCount > 1) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(slider).find('.flex-prev').on('click', function (e) {
            e.preventDefault();
            TheSlider.goToPrevSlide();
          });
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(slider).find('.flex-next').on('click', function (e) {
            e.preventDefault();
            TheSlider.goToNextSlide();
          });
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(slider).find('.slider-navigation').remove();
        }
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(slider).addClass('w-flxsd');
        (function ($) {
    ...
    setTimeout(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.icon-carousel').each(function (_, slider) {
        if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(slider).hasClass('w-flxsd')) {
          var itemID = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.getUUID)();
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(slider).attr('id', itemID);
          var TheSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + itemID + ' .slides').lightSlider({
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.table-carousel').each(function (_, slider) {
      // console.log(slider);
      if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(slider).hasClass('w-flxsd')) {
        var itemID = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.getUUID)();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(slider).attr('id', itemID);
...
var init = function init() {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.quote-carousel').length > 0 || jquery__WEBPACK_IMPORTED_MODULE_0___default()('.icon-carousel').length > 0 || jquery__WEBPACK_IMPORTED_MODULE_0___default()('.table-carousel').length > 0) {
    carouselController();
  }
};
