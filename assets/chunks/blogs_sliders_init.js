"use strict";
(self["webpackChunksekure_website"] = self["webpackChunksekure_website"] || []).push([["chunks/blogs_sliders_init"],{
...
var Sliders = /*#__PURE__*/function () {
  ...
  return _createClass(Sliders, [{
    ...
    value: function infoSliderSectionHomeSliderOut(slide, slides) {
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(slides.find('.quotes-img-wrap, .anim-translate-y, .txt-size-18'), {
        opacity: 0,
        duration: 0.3
      });
    }
    ...
    value: function infoSliderSectionHomeSliderIn(slide, swiperObj) {
      var _this = this;
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].fromTo(slide.find('.quotes-img-wrap'), {
        y: 15,
        opacity: 0
      }, {
        y: 0,
      ...
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].fromTo(slide.find('.anim-translate-y'), {
        yPercent: 100,
        opacity: 0
      }, {
        yPercent: 0,
      ...
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].fromTo(slide.find('.txt-size-18'), {
        x: -10,
        opacity: 0
      }, {
        x: 0,
        ...
        var observer = new IntersectionObserver(function (entry) {
          if (entry[0].intersectionRatio > 0) {
            if (!section.hasClass('swiper-active')) {
              slider.init();
              gsap__WEBPACK_IMPORTED_MODULE_2__["default"].set(slides.not('.swiper-slide-active').find('.quotes-img-wrap, .anim-translate-y, .txt-size-18'), {
                opacity: 0
              });
...
//# sourceMappingURL=blogs_sliders_init.js.map