"use strict";
(self["webpackChunksekure_website"] = self["webpackChunksekure_website"] || []).push([["chunks/blogs_table_controller"],{

/***/ "./assets/js/src/theme/ui/responsiveTables.js":
/*!****************************************************!*\
  !*** ./assets/js/src/theme/ui/responsiveTables.js ***!
  \****************************************************/
...
var MobileTable = function MobileTable(mobileTable) {
  ...
  tables.forEach(function (table) {
    ...
    $(window).on('resize', function(){
      var maxHeight = 0;
      $('.mt-box-inner .mt-header').each(function(){
        var thisH = $(this).outerHeight(true);
        if (thisH > maxHeight) { maxHeight = thisH; }
      });
      if(maxHeight > $('.fixed-column-inner .mt-header').outerHeight(true)) {
        $('.mt-box-inner .mt-header, .fixed-column-inner .mt-header').height(maxHeight);
      } else {
        $('.mt-box-inner .mt-header, .fixed-column-inner .mt-header').height($('.fixed-column-inner .mt-header').outerHeight(true));
      }
    });
    */
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(".blaze-next[data-btn-for=\"".concat(tableID, "\"]")).on('click', function (e) {
      e.preventDefault();
      slider.next();
    });
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(".blaze-prev[data-btn-for=\"".concat(tableID, "\"]")).on('click', function (e) {
      e.preventDefault();
      slider.prev();
    });
...
//# sourceMappingURL=blogs_table_controller.js.map