...
!(function (n) {
    'function' == typeof define && define.amd
        ...
        ? (module.exports = function (e, t) {
              return (
                  void 0 === t && (t = 'undefined' != typeof window ? require('jquery') : require('jquery')(e)), n(t), t
              )
          })
        : n(jQuery)
})(function (t) {
            ...
            u.define('select2/results', ['jquery', './utils'], function (d, p) {
                ...
                return (
                    ...
                    (s.prototype.render = function () {
                        ...
                        return (
                            this.options.get('multiple') && e.attr('aria-multiselectable', 'true'), (this.$results = e)
                        )
                    }),
                    ...
                    (e.prototype.query = function (e, t, n) {
                        ...
                        var i = this.tokenizer(t, this.options, function (e) {
                            ...
                            s.$element.find('option').filter(function () {
                                ...
                                ((t = s.option(n)).attr('data-select2-tag', !0), s._removeOldTags(), s.addOptions([t])),
                                (t = n),
                ...
                function (l, r, o, a, c, u, d, p, h, f, g, t, m, y, v, _, b, $, w, x, A, D, S, E, O, C, L, T, q, I, e) {
                    ...
                    return (
                        (n.prototype.apply = function (e) {
                            ...
                            return (
                                (e.language = n), (e.translations = this._processTranslations(e.language, e.debug)), e
                            )
                        }),
