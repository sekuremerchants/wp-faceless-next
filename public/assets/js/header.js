...
mobileNavBtn.addEventListener('click', function(){
	...
	if(!htmlElement[0].classList.contains('mobile-menu-opened')) {
		...
		if(htmlElement[0].classList.contains('header-toggled-state')) {
			logo.src = '/logo/en/logo-blue-descriptor.webp'
		} else {
			logo.src = '/logo/en/logo-blue-descriptor-tagline.webp'
		}
	} else {
		htmlElement[0].classList.remove('mobile-menu-opened')
		if(htmlElement[0].classList.contains('header-toggled-state')) {
			logo.src = '/logo/en/logo-white-descriptor.webp'
		} else {
			logo.src = '/logo/en/logo-white-descriptor-tagline.webp'
		}
	}
})
