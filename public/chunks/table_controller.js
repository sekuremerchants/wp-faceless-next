"use strict";
(self["webpackChunksekure_website"] = self["webpackChunksekure_website"] || []).push([["chunks/table_controller"],{
  ...
  tables.forEach(function (table) {
    ...
    $(window).on('resize', function(){
      ...
      $('.mt-box-inner .mt-header').each(function(){
        ...
        if (thisH > headerHeights) { headerHeights = thisH; }
      });
      $('.mt-box-inner .mt-header, .fixed-column-inner .mt-header').css("height", headerHeights + "px");
    });
    */
